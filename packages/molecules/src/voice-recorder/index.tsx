    ...
    <div>
      ...
      {/* <Box style={customStyles.centerStyles || defaultCenterStyles}>
        {mediaRecorder && mediaRecorder.state === 'recording' ? (
          <RecorderControl status="recording" onClick={stopRecording} includeDiv={includeDiv} primaryColor={''} primaryDarkColor={''} />
        ) : (
          <Box style={defaultCenterStyles}>
            {recorderStatus === 'processing' ? (
              <RecorderControl status="processing" onClick={() => {}} primaryColor={''} primaryDarkColor={''} />
