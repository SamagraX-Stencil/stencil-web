...
var NewMessageItem = function NewMessageItem(_ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_bubble.UpdatedBubble, {
    ...
    SpeakerIcon: _speaker.default,
    MsgThumbsUp: _msgThumbsUp.default,
    MsgThumbsDown: _msgThumbsDown.default,
    offlineBtnsStyle: _indexModule.default.offlineBtns,
    messageSpeakerStyle: _indexModule.default.msgSpeaker,
    tableContinerStyle: _indexModule.default.tableContainer,
    messageTriangleLeftStyle: _indexModule.default.messageTriangleLeft,
    messageTriangleRightStyle: _indexModule.default.messageTriangleRight,
    optionsTextStyle: _indexModule.default.optionsText,
    textBubbleStyle: _indexModule.default.textBubble,
    msgFeedbackIconsStyle: _indexModule.default.msgFeedbackIcons,
    msgFeedbackStyle: _indexModule.default.msgFeedback,
    getLists: getLists,
    reaction: reaction
  });
};
var _default = exports.default = NewMessageItem;